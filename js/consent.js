...
(function () {
  ...
  b.style.cssText = "position:fixed;bottom:0;left:0;right:0;z-index:300;background:rgba(8,12,20,.96);border-top:1px solid rgba(255,255,255,.08);padding:16px 88px 16px 20px;display:flex;gap:14px;align-items:center;justify-content:space-between;flex-wrap:wrap;font-family:DM Sans,sans-serif;font-size:.84rem;color:#e8edf5";
